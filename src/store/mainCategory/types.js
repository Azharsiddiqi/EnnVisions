// <-----------------------Beginning Business category Section----------------------->

export const ADD_NEW_BUSINESS_CATEGORY_ITEM = 'ADD_NEW_BUSINESS_CATEGORY';
...
export const ADD_NEW_BUSINESS_TYPE_ITEM = 'ADD_NEW_BUSINESS_TYPE_ITEM';
export const GET_BUSINESS_TYPE_ITEMS = 'GET_BUSINESS_TYPE_ITEMS';
export const UPDATE_BUSINESS_TYPE_ITEM = 'UPDATE_BUSINESS_TYPE_ITEM';
...
export const GET_HOUSE_DELIVERY = 'GET_HOUSE_DELIVERY';
...
export const GET_OPEN_STATUS = 'ADD_OPEN_STATUS_GET';
...
export const GET_ALCOHOL = 'ADD_ALCOHOL_GET';
