                            ...
                            <div className="dash-body">
                                ...
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col" className="pg-14-name">DiDI Cab</td>
                                        <td scope="col" className="pg-14-name">a----21@gmail.com</td>
                                        <td scope="col" className="pg-14-name">+923008134076</td>
                                        <td scope="col" className="pg-14-name">Document_details</td>
                                        <td scope="col" className="pg-14-name">13-August-2020</td>
                                        <td scope="col" className="td-action-icon">
                                        <Link to="page-6.html">
                                            <span className="preparation-t">
                                            <img src="assets/images/ic_prepration_time.svg" />
                                            </span>
                                        </Link>
                                        <span className="item-list">
                                            <img src="assets/images/ic_item_list.svg" />
                                        </span>
                                        <span className="ic-schedule" data-toggle="modal" data-target="#exampleModal">
                                            <img src="assets/images/ic_schedule.svg" />
                                        </span>
                                        {/* Modal */}
