            ...
            <div className="page-3-table">
              <table className="table">
                <thead className="user-thead gilroy-semibold">
                  <tr>
                    <th scope="col" className="vendor-id">
                      ID
                    </th>
                    <th scope="col" className="vendor-name">
                      COMPANY NAME
                    </th>
                    <th scope="col" className="vendor-email">
                      EMAIL
                    </th>
                    <th scope="col" className="vendor-phone">
                      PHONE
                    </th>
                    <th scope="col" className="vendor-created">
                      CREATED AT
                    </th>
                    <th scope="col" className="vendor-outlet">
                      OUTLET
                    </th>
                    <th scope="col" className="vendor-rating">
                      RATING
                    </th>
                    <th scope="col" className="vendor-commission">
                      COMMISSION
                    </th>
                    <th scope="col" className="vendor-action">
                      ACTION
                    </th>
                  </tr>
                </thead>
                    ...
                    <td className="vendor-id">
                      ...
                      <span className="vendor-image">
                        <img
                          ...
                          onClick={() => {
                            navigate(
                              PRIVATE_ROUTES.vendorManageJawafa.vendorDetailJawafa.path,
                            );
                          }}
                        />
                      </span>
                    </td>
                    <td className="vendor-name-td">PIZZA HUT</td>
...
export default vendorListJawafa;