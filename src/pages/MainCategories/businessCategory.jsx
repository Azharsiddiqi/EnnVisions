...
import {
  ACTION_addNewBusinessCategoryItem,
  ACTION_getBusinessCategoryItems,
...
export default () => {
  ...
  const {businessCategoriesItems} = useSelector((state) => state.mainCategory);
  // begin item states
  ...
  const addNewItemHandler = () => {
    ...
    dispatch(ACTION_addNewBusinessCategoryItem(reqPacket));
    resetItem();
  };
  ...
  const updateItemHandler = (e) => {
    ...
    dispatch(ACTION_updateBusinessCategoryItem(reqPacket));
    resetEditItem();
  };
  ...
  const deleteItemHandler = () => {
    ...
    dispatch(ACTION_deleteBusinessCategoryItem(reqPacket));
    setShow(false);
    setDeleteItem(null);
  };
  ...
  const updateBusinessCategoryHandler = () => {
    if (!title) return;

    const businessCategoryIds = [];
    businessCategoriesItems.forEach((_item) => {
      businessCategoryIds.push({
        id: _item.id,
      });
    });
    ...
    dispatch(ACTION_updateBusinessCategoriesDropdownList(reqPacket));
  };
            ...
            <div className="row">
              <div className="col-md-5">
                    ...
                    <div className="row c-vendor-checboxes">
                      <label className="plain-check checkbox checkbox-lg bg-check col-xl-6">
                        <input
                          type="checkbox"
                          name="Checkboxes3_1"
                          checked={isDdisplayTitle}
                          onChange={() => setIsDdisplayTitle(true)}
                        />
                        <span />
                        Active
                      </label>
                      <label className="plain-check checkbox checkbox-lg bg-check col-xl-6">
                        <input
                          ...
                          name="Checkboxes3_1"
                          checked={!isDdisplayTitle}
                          onChange={() => setIsDdisplayTitle(false)}
                        />
                        <span />
                        InActive
                      </label>
                ...
                <div className="creat-main-category-submit  mt-5">
                  <button className="btn" type="button" onClick={updateBusinessCategoryHandler}>
                    UPDATE
                  </button>
                </div>
              </div>
