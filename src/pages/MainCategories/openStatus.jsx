...
import {
  ACTION_addOpenStatus,
  ACTION_getOpenStatus,
...
export default () => {
  ...
  // Starting Open Status Service states
  ...
  const addNewItemHandler = () => {
    ...
    dispatch(ACTION_addOpenStatus(reqPacket));
  };
  const updateItemHandler = (e) => {
    ...
    dispatch(ACTION_updateOpenStatus(reqPacket));
    resetEditItem();
  };
  ...
  const deleteItemHandler = () => {
    ...
    dispatch(ACTION_deleteOpeningStatusSetup(reqPacket));
    setShow(false);
    setDeleteItem(null);
  };
  ...
  const updateOpenStatusHandler = () => {
    if (!title) return;

    const dtoOpeningStatusIds = [];
    openingStatusItems.forEach((_item) => {
      dtoOpeningStatusIds.push({
        id: _item.id,
      });
    });
    ...
    dispatch(ACTION_updateOpeningStatusSetup(reqPacket));
  };
            ...
            <div className="row">
              <div className="col-md-5">
                ...
                <div className="creat-main-category-submit  mt-5">
                  <button className="btn" type="button" onClick={updateOpenStatusHandler}>
                    UPDATE
                  </button>
                </div>
              </div>
