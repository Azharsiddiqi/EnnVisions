...
const HouseDeliverService = () => {
  ...
  // Starting House Delivery Service states
  ...
  const updateItemHandler = (e) => {
    ...
    dispatch(ACTION_updateHouseDelivery(reqPacket));
    resetEditItem();
  };
  ...
  const updateHouseDeliveryServiceHandler = () => {
    if (!title) return;

    const dtoHouseDeliveryOptionlList = [];
    houseDeliveryServiceItems.forEach((_item) => {
      dtoHouseDeliveryOptionlList.push({
        id: _item.id,
      });
    });

    const reqPacket = {
      dtoHouseDeliveryOptionlList,
      title,
      description,
      isDisplayTitle,
    ...
    dispatch(ACTION_updateHouseDeliverySetup(reqPacket));
  };
              ...
              <div className="col-md-5">
                ...
                <div className="creat-main-category-submit  mt-5">
                  <button
                    className="btn"
                    type="button"
                    onClick={updateHouseDeliveryServiceHandler}
                  >
                    UPDATE
                  </button>
                </div>
...
export default HouseDeliverService;