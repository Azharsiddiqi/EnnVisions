                ...
                <div className="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div className="content  d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div className=" container ">
                            ...
                            {/*begin::Row*/}
                            <div className="row">
                            <div className="dash-body page-8-container">
                                <div className="breakfast-container">
                                <div className="row">
                                    <div className="col-sm-4 parent-container">
                                    <div className="breakfast-content">
                                        <div>
                                        <img src="assets/images/ic_change_position.svg" alt=""/>
                                        <p className="b-favour">Breakfast Favorites</p>
                                        </div>
                                        <div>
                                    ...
                                    <div className="breakfast-content border-0">
                                    </div>
                                    <div className="breakfast-content border-0">
                                    </div>
                                    <div className="breakfast-content border-0">
                                    </div>
                                    <Link to="page-15.html">
                                        <div className="breakfast-content border-0">	
                                        <p className="add-new">+ ADD NEW MENU</p>	
                                        </div>
                                    </Link>
                                    </div>
                                    <div className="col-sm-4 parent-container">
                                    ...
                                    <div className="breakfast-content border-0">
                                        <Link to="page-23.html">
                                        <p className="add-new">+ ADD NEW CATEGORY</p>
                                        </Link>
                                    </div>
                                    </div>
                                    <div className="col-sm-4 parent-container">
                                    <div className="last-parent-pg-8">
                                        <div className="breakfast-content">
                                        <div>
                                            <img src="assets/images/ic_change_position.svg" alt=""/>
                                            <p className="b-favour">Breakfast Favorites</p>
                                        ...
                                        <div>
                                            <img src="assets/images/ic_more.svg" />
                                        </div>
                                        </div>
                                        <div className="breakfast-content">
                                        <div>
                                        ...
                                        <div className="breakfast-content">
                                        <div>
                                            <img src="assets/images/ic_change_position.svg" />
                                            <p className="b-favour">Breakfast Favorites</p>
                                        </div>
                                        <div>
                                            <img src="assets/images/ic_more.svg" alt=""/>
                                    ...
                                    <div className="breakfast-content border-0">
                                        <Link to="page-26.html">
                                        <p className="add-new">+ ADD NEW ITEMS</p>
                                        </Link>
                                    </div>
                                    </div>
                                </div>
