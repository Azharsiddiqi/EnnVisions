        ...
        <div className="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div className="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
                <div className=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                    ...
                    <div className="d-flex align-items-center flex-wrap mr-2">
                        ...
                        <span className="gilroy-medium inactive-breadcrumb semi-dark-text text-muted font-weight-bold mr-4">EDIT OUTLET</span>
                        {/*end::Actions*/}
                    </div>
                </div>
            </div>
            ...
            <div className="d-flex flex-column-fluid">
                ...
                <div className=" container ">
                    <div className="vendor-body page-12-content page-18-content">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-5 vendor-location-div">
                                        ...
                                        <div className="form-group location-div">
                                            ...
                                            <div className="map">
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2602.344082631407!2d-123.1133149490098!3d49.28882477923052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5486719d24e2e021%3A0xb7057fe085c86109!2sCanada%20Place!5e0!3m2!1sen!2s!4v1601402609000!5m2!1sen!2s" style={{ border: 0, width: '100%' }} allowFullScreen width={600} height={450} frameBorder={0} title='google-map'>
                                                </iframe>
                                            </div>
                                            <div className="create-vendor-submit">
                                                <button className="btn" type="submit" onClick={() => history.push(PRIVATE_ROUTES.dashboard.path)} > SUBMIT </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
