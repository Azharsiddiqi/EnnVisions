                ...
                <table className="table overall-statement">
                  <thead className="user-thead gilroy-semibold">
                    <tr>
                      ...
                      <th scope="col" className="role-name">AGENT NAME</th>
                      <th scope="col" className="role-name">VENDOR</th>
                      <th scope="col" className="second-referrer">OUTLET</th>
                      <th scope="col" className="role-company">HELPER</th>
                      ...
                      <th scope="col" className="role-create">AGENT EARN</th>
                      <th scope="col" className="role-create">G.S.TAX</th>
                      <th scope="col" className="role-create">ADMIN PAYOUT</th>
                      <th scope="col" className="role-create">FLEET PAYOUT</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="user-company">$50.25</td>
