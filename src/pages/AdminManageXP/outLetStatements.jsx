            ...
            <div className="table-content">
              <div className="overall-statement-container">
                ...
                <span className="statement-block fleet-com">
                  <p>VENDOR COMMISSIONS</p>
                  <p>10</p>
                </span>
              </div>
              <table className="table overall-statement out-let-statement-table">
                <thead className="user-thead gilroy-semibold">
                  <tr>
                    <th scope="col" className="role-id">ID</th>
                    <th scope="col" className="role-name">OUT LET NAME</th>
                    <th scope="col" className="role-name">LOCATION ADDRESS</th>
                    <th scope="col" className="second-referrer">HELPER</th>
                    <th scope="col" className="role-company">DELIVER</th>
                    <th scope="col" className="role-company">PICKUP</th>
                    <th scope="col" className="role-create">CANCEL</th>
                    <th scope="col" className="role-create">IN PROGRESS</th>
                    <th scope="col" className="role-create">OUT LET EARN</th>
                    <th scope="col" className="role-create">G.S.TAX</th>
                    <th scope="col" className="role-create">ADMIN PAYOUT</th>
                    <th scope="col" className="role-create">CREATED DATE</th>
                    <th scope="col" className="role-create">RATINGS</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="user-company">50</td>
                    <td className="user-company">25</td>
                    <td className="user-company">5</td>
                    <td className="user-company">250</td>
...
export default outLetStatements;
