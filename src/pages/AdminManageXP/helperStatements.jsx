              ...
              <table className="table overall-statement">
                <thead className="user-thead gilroy-semibold">
                  <tr>
                    ...
                    <th scope="col" className="role-name">HELPER</th>
                    <th scope="col" className="role-name">DELIVER</th>
                    <th scope="col" className="second-referrer">PICKUP</th>
                    <th scope="col" className="role-company">CANCEL</th>
                    <th scope="col" className="role-company">IN PROGRESS</th>
                    <th scope="col" className="role-company">HELPER EARN</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="user-company">25</td>
                    <td className="user-company">257</td>
...
export default helperStatements;
