                ...
                <table className="table overall-statement">
                  <thead className="user-thead gilroy-semibold">
                    <tr>
                      ...
                      <th scope="col" className="role-name">DISPATCHER</th>
                      <th scope="col" className="role-name">DRIVER</th>
                      <th scope="col" className="second-referrer">WAITER</th>
                      <th scope="col" className="role-company">CANCEL</th>
                      <th scope="col" className="role-company">IN PROGRESS</th>
                      <th scope="col" className="role-create">DISPACTHER EARN</th>
                      ...
                      <th scope="col" className="role-create">ORDER STATUS</th>
...
export default dispatcherStatements;
