                ...
                <div className=" container ">
                    ...
                    <div className="dash-body page-15-container">
                        ...
                        <div className="pg-15-menu-content">
                            <p className="category-appearing">Menus for category to appearing*</p>
                            <div className="all-diner-breakfast">
                                <button type="button" className="btn all-day">ALL DAY MENU</button>
                                <button type="button" className="btn diner-menu">DINNER MENU</button>
                                <button type="button" className="btn all-day">BREAKFAST &amp; BURGER</button>
                            </div>
                        </div>
                    </div>
                    </div>
