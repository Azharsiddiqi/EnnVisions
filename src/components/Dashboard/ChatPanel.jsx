            ...
            <div className="card card-custom">
                ...
                <div className="scroll scroll-pull" data-height={375} data-mobile-height={300}>
                    ...
                    <div className="d-flex flex-column mb-5 align-items-start">
                        ...
                        <div>
                            <Link to="#" className="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</Link>
                    ...
                    <div className="d-flex flex-column mb-5 align-items-end">
                        ...
                        <div>
                            ...
                            <Link to="#" className="text-dark-75 text-hover-primary font-weight-bold font-size-h6">You</Link>
                        </div>
                    ...
                    <div className="d-flex flex-column mb-5 align-items-start">
                        ...
                        <div className="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">
                        You can unwatch this repository immediately by clicking here: <Link to="#">https://github.com</Link>
                        </div>
                    </div>
                    {/*end::Message In*/}
                    {/*begin::Message Out*/}
                ...
                <div className="d-flex align-items-center justify-content-between mt-5">
                    <div className="mr-3">
                    <Link to="#" className="btn btn-clean btn-icon btn-md mr-1"><i className="flaticon2-photograph icon-lg" /></Link>
                    <Link to="#" className="btn btn-clean btn-icon btn-md"><i className="flaticon2-photo-camera  icon-lg" /></Link>
                    </div>
                    <div>
