        ...
        <div id="kt_quick_user" className="offcanvas offcanvas-right p-10">
            ...
            <div className="offcanvas-content pr-5 mr-n5">
                ...
                <div className="d-flex flex-column">
                    ...
                    <Link to="#" className="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</Link>
                    </div>
                </div>
                </div>
                {/*end::Header*/}
                ...
                {/*end:Item*/}
                {/*begin::Item*/}
                <Link to="custom/apps/user/profile-3.html" className="navi-item">
                    <div className="navi-link">
                    <div className="symbol symbol-40 bg-light mr-3">
                        <div className="symbol-label">
                ...
                {/*end:Item*/}
                {/*begin::Item*/}
                <Link to="custom/apps/user/profile-2.html" className="navi-item">
                    <div className="navi-link">
                    <div className="symbol symbol-40 bg-light mr-3">
                        <div className="symbol-label">
