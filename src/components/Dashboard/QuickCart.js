    ...
    render() {
        return (
            ...
            <div className="offcanvas-header d-flex align-items-center justify-content-between pb-7">
                ...
                <Link to="#" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_cart_close">
            ...
            <div className="offcanvas-content">
                ...
                <div className="d-flex align-items-center justify-content-between py-8">
                    ...
                    <Link to="#" className="font-weight-bold text-dark-75 font-size-lg text-hover-primary">
                        iBlender
                    </Link>
                    ...
                    <div className="d-flex align-items-center mt-2">
                        ...
                        <Link to="#" className="btn btn-xs btn-light-success btn-icon mr-2"><i className="ki ki-minus icon-xs" /></Link>
                        <Link to="#" className="btn btn-xs btn-light-success btn-icon"><i className="ki ki-plus icon-xs" /></Link>
                    </div>
                    </div>
