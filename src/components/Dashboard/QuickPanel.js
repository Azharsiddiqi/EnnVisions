            ...
            <div id="kt_quick_panel" className="offcanvas offcanvas-right pt-5 pb-10">
                        ...
                        <div className="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active" data-toggle="tab" to="#kt_quick_panel_logs">Audit Logs</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" data-toggle="tab" to="#kt_quick_panel_notifications">Notifications</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" data-toggle="tab" to="#kt_quick_panel_settings">Settings</Link>
                            </li>
                            </ul>
                            <div className="offcanvas-close mt-n1 pr-5">
                            <Link to="#" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_panel_close">
                        ...
                        <div className="offcanvas-content px-10">
                            ...
                            <div className="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                                ...
                                <div className="d-flex align-items-center flex-wrap mb-5">
                                    ...
                                    <Link to="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Top Authors</Link>
                                ...
                                <div className="d-flex align-items-center flex-wrap mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Popular Authors</Link>
                                    <span className="text-muted font-weight-bold">Most Successful Fellas</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center flex-wrap mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">New Users</Link>
                                    <span className="text-muted font-weight-bold">Most Successful Fellas</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center flex-wrap mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Active Customers</Link>
                                    <span className="text-muted font-weight-bold">Most Successful Fellas</span>
                                    </div>
                                    <span className="btn btn-sm btn-light font-weight-bolder my-lg-0 my-2 py-1 text-dark-50">+4500$</span>
                                </div>
                                ...
                                <div className="d-flex align-items-center flex-wrap">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">Bestseller Theme</Link>
                                    <span className="text-muted font-weight-bold">Most Successful Fellas</span>
                                    </div>
                                    <span className="btn btn-sm btn-light font-weight-bolder my-lg-0 my-2 py-1 text-dark-50">+4500$</span>
                                </div>
                                ...
                                <div className="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Another purpose persuade</Link>
                                ...
                                <div className="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Would be to people</Link>
                                    <span className="text-muted font-size-sm">Due in 2 Days</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center bg-light-danger rounded p-5 mb-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">Purpose would be to persuade</Link>
                                    <span className="text-muted font-size-sm">Due in 2 Days</span>
                                    </div>
                                ...
                                <div className="d-flex align-items-center bg-light-info rounded p-5">
                                    ...
                                    <div className="d-flex flex-column flex-grow-1 mr-2">
                                    <Link to="#" className="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">The best product</Link>
                                    <span className="text-muted font-size-sm">Due in 2 Days</span>
                                    </div>
                            ...
                            <div className="tab-pane fade pt-2 pr-5 mr-n5" id="kt_quick_panel_notifications" role="tabpanel">
                                ...
                                <Link to="#" className="navi-item">
                                    <div className="navi-link rounded">
                                    <div className="symbol symbol-50 mr-3">
                                        <div className="symbol-label"><i className="flaticon2-supermarket text-warning icon-lg" /></div>
                                    </div>
                                    <div className="navi-text">
                                        <div className="font-weight-bold  font-size-lg">
                                ...
                                <Link to="#" className="navi-item">
                                    <div className="navi-link rounded">
                                    <div className="symbol symbol-50 mr-3">
                                        <div className="symbol-label"><i className="flaticon-paper-plane-1 text-success icon-lg" /></div>
                                    </div>
                                    <div className="navi-text">
                                        <div className="font-weight-bold  font-size-lg">
                                ...
                                <Link to="#" className="navi-item">
                                    <div className="navi-link rounded">
                                    <div className="symbol symbol-50 mr-3">
                                        <div className="symbol-label"><i className="flaticon2-supermarket text-danger icon-lg" /></div>
                                    </div>
                                    <div className="navi-text">
                                        <div className="font-weight-bold  font-size-lg">
                                        $2900 worth producucts sold
