...
export default () => {
    ...
    const { userRoles, dashboard, adminManage, fleetManage, dispatcherManage, vendorManage, driverManage } = PRIVATE_ROUTES;
            ...
            <div className="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" className="aside-menu my-4 " data-menu-vertical={1} data-menu-scroll={1} data-menu-dropdown-timeout={500}>
                    ...
                    <ul className="menu-nav ">
                                ...
                                <ul className="menu-subnav">
                                    ...
                                    <li className={`menu-item  menu-item-submenu ${subActive === "vendorManageJawafa" ? "menu-item-open" : ""}`} >
                                        ...
                                        <div className="menu-submenu"
                                            ...
                                            <i className="menu-arrow" />
                                            <ul className="menu-subnav">
                                                <li className={`menu-item  ${pathname === vendorManage.createVendor.path ? "menu-item-active" : ""}`} aria-haspopup="true">
                                                ...
                                                <li className={`menu-item  ${pathname === vendorManage.vendorList.path ? "menu-item-active" : ""}`} aria-haspopup="true">
                                                    <Link to={vendorManage.vendorList.path} className="menu-link ">
                                                        <i className="menu-bullet menu-bullet-dot"><span /></i>
                                                        <span className="menu-text" >Vendor List</span>
                                                    </Link>
                                                </li>
                                                <li className={`menu-item  ${pathname === vendorManage.helperList.path ? "menu-item-active" : ""}`} aria-haspopup="true">
                        ...
                        <li className={`menu-item  menu-item-submenu ${mainActive === "driverManage" ? "menu-item-open" : ""}`}>
                            <div onClick={() => setMainActive(mainActive !== 'driverManage' ? 'driverManage' : "")} className="menu-link ">
                            ...
                            <div className="menu-submenu">
                                ...
                                <ul className="menu-subnav">
                                    ...
                                    <li className={`menu-item  menu-item-submenu ${subActive === "adminManageJawafa" ? "menu-item-open" : ""}`} >
                                        <div onClick={() => setSubActive(subActive !== 'adminManageJawafa' ? 'adminManageJawafa' : "")} className="menu-link">
                                            <i className="menu-bullet menu-bullet-line">
                                                <span />
                                            </i>
                                            <span className="menu-text">Jawafa</span>
